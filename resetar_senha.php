                        ...
                        <form class="md-float-material">
                            ...
                            <div class="auth-box">
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                        <h3 class="text-left txt-primary">Esqueceu a senha</h3>
                                    </div>
                                </div>
                                <hr/>
                                <p style="color:black;"> Digite seu email e senha enviado para ele.<p>
                                ...
                                <div class="row m-t-25 text-left">
                                    ...
                                    <div class="col-sm-5 col-xs-12 forgot-phone">
                                        <a href="resetar_senha.php" class="text-right f-w-600 text-inverse"> Voltar</a>
                                    </div>
                                </div>
