...
$pagina = "inicial.php";  //Variavel pagina que vai inicial.php
if(isset($_GET['p'])) {     // Se existir a variavel p entao 
    $pagina = $_GET['p'] . ".php"; //transformar minha variavel pagina na variavel p e concatenar com o .php
}
                    ...
                    <div class="pcoded-content">
                        <div class="pcoded-inner-content">
                            ...
                            <div class="main-body">
                                ...
                                <?php include('Pages/' . $pagina);?> <!--Colocando a variavel paginas que veio de cima-->
